...
public class Instruction {
    ...
    public Instruction(String linia, HashMap<String,Integer> etykiety) throws Exception {
        ...
        if (!linia.equals("")) {
            ...
            String[] rozkazy = new String[]{"jmpr","callr","random","savea","cmpa","nint","int","off","uoff","adda","suba","anda","eora","xora","sot","nop","hlt","addr","set","in","out","inc","jmp","save","ram","uram","exp","rexp","not","add","sub","and","eor","shl","shr","xor","jeq","jeeq","res","jgt","jegt","jlt","jelt","dec","cmp","read","mov","pop","push","mul","emul","div","rem","call","ret"};
            ...
            if(poprawnaKomenda){
                ...
                throw new Exception("Nie ma takiego rozkazu "+linia);
            }
