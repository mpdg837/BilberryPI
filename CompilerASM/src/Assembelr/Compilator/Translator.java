...
public class Translator {
    ...
    public String translateParam(String reg) throws Exception {
        ...
        switch (reg){
            ...
            case "-2" -> {return "10";}
            case "-3" -> {return "11";}
            default -> {throw new Exception("Nieprawidłowy zapis parametru "+ reg);}
        }
    }
    ...
    public String makeLineRegDoubleArg(String insturction, String reg1,String arg) throws Exception {
    ...
    public String makeTwoLineRegArg(String insturction, String reg1, String reg2,String arg) throws Exception {
        ...
        if(insturction.length()==5) {
            ...
            build.append(translateReg(reg1));
            build.append(translateParam(reg2));
